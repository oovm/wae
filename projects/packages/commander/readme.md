...
**Self-update** is **not** a CLI concern: upgrade `@wae/wae` via npm. **Shipped apps** (`wae build` products) use the Rust [`wae-self-update`](../../crates/wae-self-update/readme.md) crate against **your app's** GitHub Releases (native `wae-napi` addon).
