...
| [`wae-updater`](wae-updater/readme.md)                 | Product updater: version/channel check, download, apply (`lib/`)  |
| [`wae-builder`](wae-builder/readme.md)                 | Product builder: compile native, icons, verify, package releases  |
